...
LastEditors: xm_cmic
LastEditTime: 2024-05-10 20:27:53
FilePath: /src-0508/model/grounded_model.py
Description: 
...
class Grounded_VQA_Model(nn.Module):
    def __init__(self,tokenizer,language_model,vision_backbone='UNET',vision_pretrained=None,vision_learnable = True,text_dim = 4096):
        ...
        self.prompt_encoder = Prompt_Encoder(text_dim)
        self.image_proj_mlp = {
            'UNET' : nn.Sequential(
