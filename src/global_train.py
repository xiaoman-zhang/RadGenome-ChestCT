...
def main():
    ...
    print("Setup Data")
    Train_dataset = CTRATE_Dataset(data_args.train_image_path_csv,data_args.train_regioned_report_csv,data_args.train_qa_abnormality_csv,data_args.train_qa_location_csv,data_args.train_qa_presence_csv,data_args.train_qa_size_csv,data_args.train_disorders_csv,data_args.train_mask_root_dir,data_args.train_anatomy_mask_root_dir,tokenizer=tokenizer,train=True)
