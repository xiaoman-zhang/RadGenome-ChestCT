...
from dataset.dataset_global import CTRATE_Dataset_Global
...
class DataArguments:
    ...
    train_image_path_csv: Optional[str] = field(default='./radgenome_files/subset/train_image_path.csv')
    test_image_path_csv: Optional[str] = field(default='./radgenome_files/validation_image_path.csv')
    
    train_regioned_report_csv: Optional[str] = field(default='./radgenome_files/subset/train_region_report.csv')
    test_regioned_report_csv: Optional[str] = field(default='./radgenome_files/subset_validation/validation_region_report.csv')
    
    train_qa_abnormality_csv: Optional[str] = field(default='./radgenome_files/subset/train_vqa_abnormality.csv')
    test_qa_abnormality_csv: Optional[str] = field(default='./radgenome_files/subset_validation/validation_vqa_abnormality.csv')
    
    train_qa_location_csv: Optional[str] = field(default='./radgenome_files/subset/train_vqa_location.csv')
    test_qa_location_csv: Optional[str] = field(default='./radgenome_files/subset_validation/validation_vqa_location.csv')
    
    train_qa_presence_csv: Optional[str] = field(default='./radgenome_files/subset/train_vqa_presence.csv')
    test_qa_presence_csv: Optional[str] = field(default='./radgenome_files/subset_validation/validation_vqa_presence.csv')
    
    train_qa_size_csv: Optional[str] = field(default='./radgenome_files/subset/train_vqa_size.csv')
    test_qa_size_csv: Optional[str] = field(default='./radgenome_files/subset_validation/validation_vqa_size.csv')
    
    train_disorders_csv: Optional[str] = field(default='./radgenome_files/subset/train_case_disorders.csv')
    test_disorders_csv: Optional[str] = field(default='./radgenome_files/validation_case_disorders.csv')
...
if __name__ == "__main__":
    ...
    model = Global_VQA_Model(tokenizer,language_model,vision_backbone='UNET',vision_pretrained='./checkpoint/SAT_Nano.pth',vision_learnable=training_args.vision_learnable,text_dim=model_args.text_dim)
    ...
    if training_args.task == "report":
        volume_list = region_report_df['Volumename'].tolist()
        anatomy_list = region_report_df['Anatomy'].tolist()
        report_list = region_report_df['Sentence'].tolist()
        # Open the CSV file for writing
        file_path = os.path.join(training_args.output_dir, 'subset_test_results_report.csv')
        ...
        with open(file_path, mode='a', newline='') as file:
            ...
            for idx in tqdm(range(start_idx, len(region_report_df))):
                ...
                input_text = f'<Grounded report generation> Please describe the detailed finding of the {anatomy} region. <Report> {report}'# <|end_of_text|>'
